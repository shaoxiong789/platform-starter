import weixinMenu from './views/manage/menu/wxmenu.vue'
...
import daySignShow from './views/manage/daySign/daySignShow.vue'
    ...
    child:[
      {
        ...
        name:'往期日签详情',
        path:"manage/daysign/detailShow",
        icon:'el-icon-picture',
        component:daySignShow,
        visible:false
      },{
        name:'生成日签',
